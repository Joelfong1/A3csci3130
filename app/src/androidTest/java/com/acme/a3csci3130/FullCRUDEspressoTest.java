...
public class FullCRUDEspressoTest {
    ...
    public void testCreation() {
        ...
        onView(withId(R.id.submitButton)).perform(click());
        onData(anything()).inAdapterView(withId(R.id.listView)).atPosition(6).check(matches(isDisplayed()));
    }

    @Test
    public void testRead() {
        onData(anything()).inAdapterView(withId(R.id.listView)).atPosition(6).perform(click());
    ...
    public void testUpdate() throws Exception{
        ...
        onView(withId(R.id.name)).perform(typeText("Test Business2"));
        onView(withId(R.id.businessNumber)).perform(typeText("111111111"));
        onView(withId(R.id.address)).perform(typeText("1233 LeMarchant Street"), closeSoftKeyboard());
    ...
    public void testDelete() throws Exception{
        ...
        onData(anything()).inAdapterView(withId(R.id.listView)).atPosition(6).check(matches(not(isDisplayed())));
    }
}